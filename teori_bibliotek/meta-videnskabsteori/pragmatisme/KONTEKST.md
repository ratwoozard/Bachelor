...
Pragmatisme vaelger metode efter hvad der bedst besvarer forskningsspoergsmaalet i praksis. Positionen accepterer, at forskellige evidensformer kan kombineres, hvis de er kongruente med designet.
...
- Pre-go-live evidens: interviewforklaringer + artefaktspor (workflow, states, gates, tests).
- KPI-spor: beskrives som maaleplan (hvad der skal maales efter go-live), ikke som aktuelle resultater.
- Krav: central analysepaastand boer understoettes af mindst 2 empirikilder.
...
- At fund kan overfoeres bredt uden kontekstforbehold.
...
3. Hvor er jeres videnskabsteoretiske stringens?  
   Svarlinje: Den ligger i kongruensen fra ontologi/epistemologi til metodevalg.

## 7. Begraensninger

Pragmatisme kan blive for bredt, hvis datakildernes roller ikke afgraenses skarpt.
